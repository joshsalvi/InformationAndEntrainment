function [h p] = mutualinfostatnorm(x,y,varargin)
...
for i = 1:iter
    MIS(i) = mutualinformation4(Shuffle(x),Shuffle(y),0)/mutualinformation4(Shuffle(x),Shuffle(x),0);
end
...
if isempty(varargin{1})
    I = mutualinformation4(x,y,0)/mutualinformation4(x,y,0);
else
    I = varargin{1};
end
